...
<html lang="zxx">
<head>
	<title>Sabilurrosyad Boarding School</title>
	<meta charset="UTF-8">
	...
	<!-- Favicon -->   
	<link href="img/sbr.ico" rel="shortcut icon"/>
		...
		<div class="container">
			...
			<ul class="main-menu">
				...
				<li class="submenu dropdown">
					<a href="#" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Lembaga Pendidikan</a>
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		                <a class="nav-link" href="masbr/index.html">Madrasah Aliyah</a>
						<a class="nav-link" href="#">Madrasah Tsanawiyah</a>
                        <a class="nav-link" href="#">Raudathul Athfal</a>
                        <a class="nav-link" href="#">Pondok Pesantren</a>
		            </div>
				</li>
				<li class="submenu dropdown">
					<a href="#" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Portal</a>
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		                <a class="nav-link" href="#">DaftarOnline</a>
						<a class="nav-link" href="#">SCR Radio</a>
		            </div>
				</li>
		...
		<div class="hero-slider owl-carousel">
			...
			<div class="hs-item set-bg text-white" data-setbg="img/slide-1.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-7">
							<h2>Sabilurrosyad Boarding School</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris sceleri sque, at rutrum nulla dictum. Ut ac ligula sapien. Suspendisse cursus faucibus finibus.</p>
							<a href="#" class="site-btn">Lihat</a>
						</div>
					</div>
				</div>
			</div>
			...
			<!-- item -->
			<div class="hs-item set-bg text-white" data-setbg="img/slide-3.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-7">
			...
			<!-- item -->
			<div class="hs-item set-bg text-white" data-setbg="img/slide-4.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-7">
							<h2>Raudhatul Athfal</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris sceleri sque, at rutrum nulla dictum. Ut ac ligula sapien. Suspendisse cursus faucibus finibus.</p>
							<a href="#" class="site-btn">Lihat</a>
						</div>
					</div>
			...
			<div class="hs-item set-bg text-white" data-setbg="img/slide-1.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-7">
							<h2>Pondok Pesantren Sabilurrosyad</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris sceleri sque, at rutrum nulla dictum. Ut ac ligula sapien. Suspendisse cursus faucibus finibus.</p>
							<a href="#" class="site-btn">Lihat</a>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-9 about-text">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis iure voluptatum, repellendus reiciendis suscipit, debitis laboriosam nesciunt doloremque sequi. Iure enim magni eveniet itaque perferendis fugiat sapiente consectetur quaerat quia!</p>
				</div>
				<div class="col-lg-3">
					<img src="img/logosbr.png" alt="" width="65%">
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
        			<div class="col-md-5">
						...
						src="https://www.youtube.com/embed/0pqEBdJe2xQ">
						</iframe> 
        			</div>
        			<div class="col-md-7" style="float: left; ">
						<h2 style="color: #fff">Video Profil Sabilurrosyad Boarding School</h2>
		...
		<div class="container">
			...
			<div class="blog-item">
				<div class="row">
					...
					<div class="col-lg-6 blog-content">
						...
						<h3>SCOUT GAMES 2019</h3>
						<div class="blog-metas">
							<div class="blog-meta">By Admin</div> 
							<div class="blog-meta">Tags:<a href="">sabilurrosyad</a>,<a href="">pramuka,</a><a href="">jatinagara</a></div>
						</div>
			...
			<div class="blog-item">
				<div class="row">
					...
					<div class="col-lg-6 blog-content">
						<div class="date">16 Feb, 2019</div>
						<h3>Sabilurrosyad Friendship Futsal Cup 2017</h3>
						<div class="blog-metas">
							<div class="blog-meta">By Admin</div> 
							<div class="blog-meta">Tags:<a href="">sabilurrosyad</a>,<a href="">futsal,</a><a href="">jatinagara</a></div>
						</div>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis semper venenatis turpis eget suscipit. Orci varius natoque penatibus et magnis dis parturient montes. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						<a href="#" class="read-more">Selengkapnya</a>
					</div>
			...
			<div class="blog-item">
				<div class="row">
					...
					<div class="col-lg-6 blog-content">
						<div class="date">16 Feb, 2019</div>
						<h3>Angin Puting Beliung di Jatinagara</h3>
						<div class="blog-metas">
							<div class="blog-meta">By Admin</div> 
							<div class="blog-meta">Tags:<a href="">sabilurrosyad</a>,<a href="">bencana,</a><a href="">jatinagara</a></div>
						</div>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis semper venenatis turpis eget suscipit. Orci varius natoque penatibus et magnis dis parturient montes. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						<a href="#" class="read-more">Selengkapnya</a>
					</div>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="footer-widget">
						<div class="fw-about">
							<img src="img/logo-light.png" alt="" width="70%">
							<p>Phasellus vehicula tempus orci vel consequat. Nullam lorem sem, viverra a rutrum sed, gravida mattis magna. Suspendisse vitae commodo quam. Quisque a enim et ante vulputate finibus nec laoreet ipsum.</p>
							<div class="fw-social">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --><br>Developed & Redesigned By <a href="instagram.com/aqigif_fast" >Aqigif_Fast</a></div>
		</div>
	</footer>
	<!-- Footer top section end -->
